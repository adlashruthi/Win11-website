  ...
  return (
    <div>
      <div className="bg-[url('/assets/aboutimg/Group42296.svg')] h-[400px] sm:h-[460px] lg:h-[800px] bg-no-repeat bg-cover ">
        <h4 className="text-[#0B592A] text-[12px] font-mono pt-24 sm:pt-28 lg:pt-32 text-center">
          Wondering how to play Fantasy Kabaddi?
        </h4>
        <h1 className="text-[#0169B6] font-bold font-mono text-[22px] sm:text-[24px] lg:text-[28px] pl-4  lg:pt-6 text-center ">
          Watch this
