...
import TeamTalkImg from "/public/assets/jobsimg/Group 42189.png";

export default function TeamTalk() {
  return (
    <div className="flex justify-center mt-28 mb-6 flex-wrap sm:flex-nowrap">
      ...
      <div className="bg-[url('/assets/jobsimg/Ellipse560.svg')] lg:h-[480px] h-[340px] sm:h-[420px] lg:w-[350px] sm:w-[300px] w-[270px] bg-no-repeat bg-contain  sm:block">
        <div className="mt-10 lg:ml-14 sm:ml-0  sm:mr-16">
          <Image
            src={TeamTalkImg}
            alt="/"
            className="lg:h-[300px] lg:w-[390px] sm:h-[280px] sm:w-[460px] "
          />
        </div>
      </div>
    </div>
